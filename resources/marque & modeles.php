...
$modelsByMarque = [
            ...
            'Aixam' => ['City', 'Coupe', 'Crossline', 'Crossover', 'D-Truck', 'e-Truck', 'Miniauto', 'Roadline', 'Scouty R', 'Seria A'],
            ...
            'BMW' => ['Alpina', 'i3', 'i4', 'i7', 'i8', 'iX', 'iX1', 'iX3', 'M1', 'M2', 'M3', 'M4', 'M5', 'M6', 'M7', 'M8', 'Seria 1', 'Seria 2', 'Seria 3', 'Seria 4', 'Seria 5', 'Seria 6', 'Seria 7', 'Seria 8', 'X1', 'X2', 'X3', 'X3 M', 'X4', 'X4 M', 'X5', 'X5 M', 'X6', 'X6 M', 'X7', 'XM', 'Z1', 'Z3', 'Z3 M', 'Z4', 'Z4 M', 'Z8'],
            ...
            'Hummer' => ['H1', 'H2', 'H3'],
            'Hyundai' => ['Accent', 'Atos', 'Avante', 'Azera', 'Bayon', 'Coupe', 'Elantra', 'Excel', 'Galloper', 'Genesis', 'Getz', 'Grand Santa Fe', 'Grandeur', 'H-1', 'H-1 Starex', 'H200', 'H350', 'i10', 'i20', 'i30', 'i40', 'Ioniq', 'ix20', 'ix35', 'ix55', 'KONA', 'Lantra', 'Matrix', 'Pony', 'S-Coupe', 'Santa Fe', 'Santamo', 'Sonata', 'Staria', 'Terracan', 'Trajet', 'Tucson', 'Veloster', 'Veracruz', 'XG'],
            ...
            'Lexus' => ['CT', 'LC 500', 'LC 500h', 'LFA', 'Seria ES', 'Seria GS', 'Seria GX', 'Seria IS', 'Seria LS', 'Seria LX', 'Seria NX', 'Seria RC', 'Seria RX', 'Seria SC', 'UX'],
            ...
            'Maruti' => ['800', '1000'],
            'Maserati' => ['222', '224', '228', '3200', '418', '420', '4200', '422', '424', '430', 'Biturbo', 'Coupe', 'Ghibli', 'GranCabrio', 'GranSport', 'GranTurismo', 'Grecale', 'Indy', 'Karif', 'Levante', 'MC12', 'MC20', 'Merak', 'Quattroporte', 'Shamal', 'Spyder'],
            'Maxus' => ['D60', 'D90', 'G10', 'G20', 'G50', 'G70', 'G90', 'T60', 'T70', 'T90', 'EV30', 'V70', 'V80', 'V90'],
            'Maybach' => ['57', '62', 'S 500', 'S 560 4Matic', 'S-560', 'S680 4Matic'],
            'Mazda' => ['121', '2', '3', '323', '5', '6', '626', '929', 'Bongo', 'BT-50', 'CX-3', 'CX-30', 'CX-5', 'CX-60', 'CX-7', 'Demio', 'Millenia', 'MPV', 'MX-3', 'MX-30', 'MX-5', 'MX-6', 'Premacy', 'Protege', 'RX-6', 'RX-7', 'RX-8', 'Seria B', 'Seria E', 'Tribute', 'Xedos'],
            'McLaren' => ['12C', '540C', '570GT', '570S', '600LT', '620R', '625C', '650C', '675LT', '720S', '765LT', 'Elva', 'F1', 'GT', 'P1', ''],
            'Mercedes-Benz' => ['190', 'A', 'AMG', 'AMG GT-S', 'B', 'C', 'CE', 'Citan', 'CL', 'CLA', 'CLC', 'CLE', 'CLK', 'CLS', 'E', 'EQA', 'EQB', 'EQC', 'EQE', 'EQS', 'EQV', 'G', 'GL', 'GLA', 'GLB', 'GLC', 'GLC Coupe', 'GLE', 'GLE Coupe', 'GLK', 'GLS', 'GLS Maybach', 'GT2', 'Marco Polo', 'MB 100', 'ML', 'Monarch', 'R', 'S', 'S Maybach', 'SL', 'SLC', 'SLK', 'SLR', 'SLS', 'Sprinter', 'T', 'V', 'Vaneo', 'Vario', 'Viano', 'Vito', 'W108', 'W111', 'W113', 'W114', 'W115', 'W116', 'W123', 'W124', 'W126', 'W201', 'X'],
            ...
            'Porsche' => ['356', '911', '911-Turbo-S', '912', '914', '924', '928', '944', '959', '962', '968', '992', '992 Turbo S', 'Boxster', 'Carrera GT', 'Cayenne', 'Cayenne Coupe', 'Cayman', 'Macan', 'Panamera', 'Taycan'],
            'Proton' => ['Seria 300', 'Seria 400'],
            ...
            'Samsung' => ['QM5'],
            'Saturn' => ['Astra', 'Aura', 'ION Quad Coupe', 'ION Sedan', 'Outlook', 'Relay', 'SC', 'Sky', 'SL', 'SW', 'VUE'],
